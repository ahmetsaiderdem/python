...
from PyQt5.QtWidgets import QApplication,QMainWWindow


class MainForm(QMainWWindow):
    def __init__(self):
        super().__init__()
    ...
    def İnitUI(self):
        ...
        self.lbl_sonuc = QtWidgets.Qlabe(self)
    ...
    def hesapla(self):
        ...
        self.txt_sonuc.setText('sonuc : ' + str(result))
